const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container-custom relative z-10">
        <div className="text-center animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 animate-slide-up animation-delay-600">
            ...
            <div className="card p-6 text-center">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">SEBI</div>
              <div className="text-gray-600 dark:text-gray-300">Registered</div>
            </div>
          </div>
        </div>
      </div>
